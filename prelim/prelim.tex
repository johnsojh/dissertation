...
wellordered under some fixed order relation.
...
\endnote{
  ...
  Also check out the interesting answers to a couple of questions,
  \cite{Gindi:2010vn} and \cite{Kalai:2010uq}, asked on
...
If we weaken the question referred to in the Continuum Hypothesis to
ask: ``Is $|\bbR|$ bigger than $|\bbN|$?'', then the answer under ZFC
becomes an easy yes that follows from the well known diagonal argument
of Cantor.%
\endnote{
  Interestingly Grattan-Guinness observation in \cite [Note 1, page
  134]{Grattan-Guinness:1978kx} imply that du Bois Reymond was the
  first to publish a diagonal-type argument.
}
...
often easier to study than questions about absolute sizes.
However the use of cardinals to study relative sizes is somewhat
inflexible. 
(Especially as it relates to $\bbN$.)
In this section we give some basic definitions and results about two
related mathematical formulations of relative size, ultrafilters and
