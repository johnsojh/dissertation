...
Cardinality of a set is commonly thought of as a ``measure'' on 
the size a particular set.
...
theory along with the axiom of choice), every cardinality is
comparable. 
...
The Continuum Hypothesis states that the answer to the question, ``Is
$|\bbR|$ the first cardinal after $\bbN$?'', is yes; and its
independence means that, without adding extra set-theoretical axioms,
