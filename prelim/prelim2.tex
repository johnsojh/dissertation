...
\endnote{
  Even though we adopt the bias that principal filters are trivial objects, the mathematical truth of the matter is that principal filters are in fact highly \textsl{non-trivial} objects.  
