...
definitions and results we use from algebraic semigroup theory and the
...
for a more expensive, but still brief, introduction to algebraic
...
\cite{Hindman:1998fk}, and the survey papers \cite{Hindman:2002kx} and
\cite{Hindman:2010uq} contains the latest information on this
algebraic structure. 
