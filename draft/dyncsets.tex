...
\endnote{
  Depending on the enumeration, there are around five different versions of `the' Central Sets Theorem.
  Furstenberg's version \cite[Proposition 8.21]{Furstenberg:1981fk}, Bergelson's and Hindman's `pre-natural semigroup' version \cite[Theorem 4.11]{Bergelson:1990kx} and noncommutative version \cite[Theorem 2.8]{Bergelson:1992fk}, and the De, Hindman, and Strauss version \cite[Corollary 3.10]{De:2008uq}, and finally our version Corollary \ref{cor:cst}.  
  We must note however, that our Corollary \ref{cor:cst} is equivalent to \cite[Corollary 3.10]{De:2008uq}.
}
