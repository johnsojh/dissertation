...
\begin{proof}
  ...
  (Suppose that this particular claim is true, then for very positive integer $k$, there exists $i_k \in \{1, 2, \ldots, r\}$ such that $C_{i_k}$ contains a $k$-term arithmetic progression. 
