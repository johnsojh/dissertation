...
\begin{proof}
  ...
  (Observe that $B \subseteq A$ Rightarrow $\bigcup_{t \in G} -t + B \subseteq \bigcup_{t \in G} -t + A$.)
  ...
  \[
    ...
    \end{array}
  \]
% The following bits are not completely rigorous, but I think the reasoning is sound. 
...
\endnote{
  The Central Sets Theorem is often used as a convienent combinatorial substitute when applying central sets.
}
